...
var Page = function(url, coverage, callback) {
  var self = this;
  this.coverage = coverage;
  this.stylesheets = [];
  this.getBrowser(url, function(browser) {
    self.getStylesheets(url, browser, function() {
      self.checkStylesheets(url, browser, function() {
        callback();
      });
    }); 
  });
...
Page.prototype.processUrl = function(url, callback) {
  var self = this;
};
